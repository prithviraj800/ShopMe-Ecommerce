...
export default function Man(){
    return(
        <div className="lg:py-16 md:py-16 sm:py-9 py-8">
            <img src="https://img.freepik.com/premium-photo/preteen-kids-boy-girl-with-blank-advertising-placard_116547-76060.jpg?w=740" alt=""  className="md:w-full md:h-[20rem] object-cover"/>
